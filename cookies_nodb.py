...
Video_Options = Media_Options + [['بلور','Blur'],['Crop','Crop'],['كتم الصوت','Mute'],['إبدال الصوت','SubAud'],['دمج','VMerge']]
...
Photo_Options = [['دمج','IMerge'],['تلوين','Color'],['بلور','Blur'],['Ocr','Ocr']] + Photo_Audio_Ops  + Other_Opts + Translate_Opts
...
Pdf_Options = [['دمج','PMerge'],['Ocr','Ocr'],['فك قفل طباعة','Unlock'],['بلا حواشي','Marg']]  + Cbx_Option + Trim_Op
...
LANGS_Modules = [['Gemini Ai','Gemini'],['Google Translate','GTrans']]
Tracs_Modules = [['Wit Ai','Wit']] + Gemini_Model
# [['Whisper AI','Whisper']
